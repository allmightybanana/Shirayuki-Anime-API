  ...
  <script>
    const ENDPOINTS = {
      hianime: [
        ...
        { id: 'search', name: 'Search Anime (Keyword)', path: '/api/v2/hianime/search', inputs: [{ name: 'q', label: 'Query Keyword', type: 'text', default: 'One Piece' }, { name: 'page', label: 'Page Number', type: 'number', default: '1' }] },
        { id: 'search-anilist', name: 'Search by AniList ID', path: '/api/v2/hianime/search', inputs: [{ name: 'anilistId', label: 'AniList ID', type: 'number', default: '21' }] },
        { id: 'search-mal', name: 'Search by MAL ID', path: '/api/v2/hianime/search', inputs: [{ name: 'malId', label: 'MAL ID', type: 'number', default: '21' }] },
        ...
        { id: 'servers', name: 'Episode Streaming Servers', path: '/api/v2/hianime/episode/servers', inputs: [{ name: 'animeEpisodeId', label: 'Episode ID / Watch Slug (or AniList/MAL ID)', type: 'text', default: 'one-piece' }, { name: 'ep', label: 'Episode Number', type: 'number', default: '1' }, { name: 'provider', label: 'ID Provider (leave empty for slug, or: anilist, mal)', type: 'text', default: '' }] },
        { id: 'sources', name: 'Streaming Server Sources (M3U8)', path: '/api/v2/hianime/episode/sources', inputs: [{ name: 'animeEpisodeId', label: 'Episode ID / Watch Slug (or AniList/MAL ID)', type: 'text', default: 'one-piece' }, { name: 'ep', label: 'Episode Number', type: 'number', default: '1' }, { name: 'server', label: 'Server Name', type: 'text', default: 'hd-1' }, { name: 'category', label: 'Language Category (sub, dub)', type: 'text', default: 'sub' }, { name: 'provider', label: 'ID Provider (leave empty for slug, or: anilist, mal)', type: 'text', default: '' }] },
      ...
      animekai: [
        ...
        { id: 'search', name: 'Search Anime (Keyword)', path: '/api/v2/animekai/search', inputs: [{ name: 'q', label: 'Query Keyword', type: 'text', default: 'One Piece' }, { name: 'page', label: 'Page Number', type: 'number', default: '1' }] },
        { id: 'search-anilist', name: 'Search by AniList ID', path: '/api/v2/animekai/search', inputs: [{ name: 'anilistId', label: 'AniList ID', type: 'number', default: '21' }] },
        { id: 'search-mal', name: 'Search by MAL ID', path: '/api/v2/animekai/search', inputs: [{ name: 'malId', label: 'MAL ID', type: 'number', default: '21' }] },
        ...
        { id: 'servers', name: 'Episode Streaming Servers', path: '/api/v2/animekai/episode/servers', inputs: [{ name: 'animeEpisodeId', label: 'Episode Slug ID (or AniList/MAL ID)', type: 'text', default: 'one-piece-dk6r' }, { name: 'ep', label: 'Episode Number', type: 'number', default: '1' }, { name: 'provider', label: 'ID Provider (leave empty for slug, or: anilist, mal)', type: 'text', default: '' }] },
        { id: 'sources', name: 'Episode Streaming Sources', path: '/api/v2/animekai/episode/sources', inputs: [{ name: 'animeEpisodeId', label: 'Episode Slug ID (or AniList/MAL ID)', type: 'text', default: 'one-piece-dk6r' }, { name: 'ep', label: 'Episode Number', type: 'number', default: '1' }, { name: 'server', label: 'Server Name', type: 'text', default: 'server-1' }, { name: 'category', label: 'Category (sub, dub)', type: 'text', default: 'sub' }, { name: 'provider', label: 'ID Provider (leave empty for slug, or: anilist, mal)', type: 'text', default: '' }] }
      ]
    };
